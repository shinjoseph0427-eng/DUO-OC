-- WEEKLY - include weekly card place/vibe in match results.
-- Preserves the future venue hook instead of removing display code.
...
BEGIN
  ...
  WHERE wc.week_start = p_week_start
    ...
    AND wc.time_slots && v_my_card.time_slots
    AND NOT EXISTS (
